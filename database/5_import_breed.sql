...
INSERT INTO animal.breed (id, type, animal_type_id, image_data, status) VALUES (default, 'Bengal', 2, 'AAAAAA', 'A');
INSERT INTO animal.breed (id, type, animal_type_id, image_data, status) VALUES (default, 'Maine Coon', 2, 'AAAAAA', 'A');
